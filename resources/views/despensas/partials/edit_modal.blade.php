 <!-- Modal -->
 <div class="modal fade" id="ModalEditDespensas" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h4 class="modal-title" id="myCenterModalLabel">EDITAR REGISTRO</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body p-4">
                <form id="form_despensas_edit" method="POST">
                    @csrf
                    @method('POST')
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        <label for="nombre">Nombre</label>
                        <input onkeyup="mayus(this);" type="text" class="form-control" id="nombre_edit" name="nombre" required>
                        <input type="hidden" class="form-control" id="id_edit" required>

                      </div>
                      <div class="form-group col-md-4">
                        <label for="paterno">Ap.Paterno</label>
                        <input onkeyup="mayus(this);" type="text" class="form-control" id="paterno_edit" name="paterno">
                      </div>
                      <div class="form-group col-md-4">
                        <label for="materno">Ap.Materno</label>
                        <input onkeyup="mayus(this);" type="text" class="form-control" id="materno_edit" name="materno">
                      </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <input onkeyup="mayus(this);" minlength="18" maxlength="18" type="text" class="form-control" id="clave_elector_edit" name="clave_elector" >
                        </div>
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input onkeyup="mayus(this); type="text" class="form-control" id="colonia_edit" name="colonia_edit">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="cp">C.P.</label>
                            <input type="number" class="form-control" id="cp_edit" name="cp" minlength="5" maxlength="5">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="fe_nacimiento">Fecha Nacimiento</label>
                            <input type="date" class="form-control" id="fe_nacimiento_edit" name="fe_nacimiento">
                        </div>
                          <div class="form-group col-md-4">
                            <label for="fe_nacimiento">Celular</label>
                            <input type="number" class="form-control" id="celular_edit" name="celular" minlength="10" maxlength="10">
                          </div>
                          <div class="form-group col-md-12">
                            <label for="pantry">DESPENSA</label>
                            <input onkeyup="mayus(this); type="text" class="form-control" id="pantry_edit" name="pantry">
                          </div>
                      </div>
