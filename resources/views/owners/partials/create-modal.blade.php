    ...
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">REGISTRO DE PROPIETARIOS</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form id="form-owner" method="POST" action="{{ route('Owners.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <input style="text-transform:uppercase;" required type="text" name="nombre" class="form-control" autocomplete="off" minlength="2" value="{{old('nombre')}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="no_ext" class="form-control" autocomplete="off" placeholder="N/A" value="{{old('no_ext')}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                <label for="simpleinput">NO. INT</label>
                                <input type="text" name="no_int" class="form-control" autocomplete="off" placeholder="N/A" value="{{old('no_int')}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="cp" class="form-control" autocomplete="off" minlength="5" value="{{old('cp')}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" minlength="10" maxlength="10" name="celular" class="form-control" autocomplete="off" value="{{old('celular')}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
