        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="text-center">
                    <h2>
                        <a href="index.html">
                            <img src="{{asset('images/logo-light.png')}}" alt="main-logo" height="24" />
                        </a>
                    </h2>
                    ...
                    <h3 class="mt-4 text-white">
                        Estén atentos, lanzamos muy pronto</h3>
                    <p class="text-white-50">Estamos haciendo que el sistema sea más asombroso.</p>

                    <div class="row mt-5 justify-content-center">
                        <div class="col-md-8">
                            <div data-countdown="2021/02/25" class="counter-number"></div>
                        </div> <!-- end col-->
                    </div> <!-- end row-->
                </div> <!-- end /.text-center-->
