    ...
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fullWidthModalLabel">REGISTRO DE LIDERES</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form id="form" method="POST" action="{{ route('Leaders.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input  type="number" name="seccion" class="form-control" minlength="3" maxlength="3" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <input onkeyup="mayus(this);"  required type="text" name="clave_elector" class="form-control @error('clave_elector') is-invalid @enderror"  minlength="18" maxlength="18" autocomplete="off" value="{{old('clave_elector')}}">
                                @error('clave_elector')
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <input onkeyup="mayus(this);"  required type="text" name="nombre" class="form-control" autocomplete="off" value="{{old('nombre')}}" minlength="2">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="form-group mb-3">
                                ...
                                <input onkeyup="mayus(this);"  type="text" name="no_int" class="form-control" autocomplete="off" value="S/N">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                        ...
                        <div class="col-md-2">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" minlength="5" name="cp" class="form-control" autocomplete="off" value="{{old('cp')}}" minlength="5" maxlength="5">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="tel" data-parsley-type="digits" data-parsley-type="number"	name="celular" class="form-control" autocomplete="off" minlength="10" maxlength="10" value="{{old('celular')}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <textarea type="text" name="observacion" class="form-control" autocomplete="off" value="{{old('observacion')}}"></textarea>
                            </div>
                        </div>
                    </div>
