...
<<<<<<< HEAD
                        @can('delete_tocados')
                            <a style="margin: 4px" target="_blank" href="{{route('tocados_complet.pdf',$tocados[0]->mobilizer_id)}}" class="btn btn-sm btn-danger waves-effect waves-light float-right" >
                                <i class="mdi mdi-file-pdf-box-outline"></i> Reporte
                            </a>
                        @endcan
=======
                            <a style="margin: 4px" target="_blank" href="{{route('tocados_complet.pdf',$tocados[0]->mobilizer_id)}}" class="btn btn-sm btn-danger waves-effect waves-light float-right" >
                            ...
                            <a style="margin: 4px" href="{{route('Mobilizers.cr',$tocados[0]->mobilizer_id)}}" target="_blank" href="" class="btn btn-sm btn-success waves-effect waves-light float-right" >
