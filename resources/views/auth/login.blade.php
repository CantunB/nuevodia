...
<html lang="en">
    ...
    <body class="loading authentication-bg authentication-bg-pattern">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="checkbox-signin">Recordar session</label>
                                        </div>
                                    </div>
        ...
        <footer class="footer footer-alt">
            2021 - <script>document.write(new Date().getFullYear())</script> &copy; Developed <a href="" class="text-white-50">VicCode</a> 
        </footer>
